...
视频花字叠加功能（V15）为渲染的剪辑素材自动添加三行文本，提升视频的品牌识别度和观看体验。
...
- ✅ **智能布局**：避免遮挡原字幕，优化视觉层次
- ✅ **丰富样式**：10种预制样式，涵盖不同色彩主题
- ✅ **随机化元素**：热门短剧位置和显示时长随机，增加多样性
...
**显示时长**：
- **50%的播放时间显示**（10秒显示+10秒隐藏循环）
- 左右交替模式：
  - 左上角：0-10秒、40-50秒、80-90秒...
  - 右上角：20-30秒、60-70秒、100-110秒...
