...
def main():
    ...
    projects = [
        {
            'name': '假面丈夫',
            'excel': base_path / '漫剧参考/假面丈夫/丈夫的假面.xlsx',
            'result': base_path / 'data/hangzhou-leiming/analysis/假面丈夫/result.json'
        },
        {
            'name': '学乖的代价',
            'excel': base_path / '漫剧参考/学乖的代价/学乖的代价.xlsx',
            'result': base_path / 'data/hangzhou-leiming/analysis/学乖的代价/result.json'
        },
        {
            'name': '机长姐姐',
            'excel': base_path / '漫剧参考/机长姐姐/机长姐姐与寡王弟弟.xlsx',
            'result': base_path / 'data/hangzhou-leiming/analysis/机长姐姐/result.json'
        },
        {
            'name': '精准',
            'excel': base_path / '漫剧参考/精准/精准猎物.xlsx',
            'result': base_path / 'data/hangzhou-leiming/analysis/精准/result.json'
        },
        {
            'name': '紫雪',
            'excel': base_path / '漫剧参考/紫雪/紫雪容忍.xlsx',
            'result': base_path / 'data/hangzhou-leiming/analysis/紫雪/result.json'
        }
    ]
