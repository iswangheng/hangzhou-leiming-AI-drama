...
V14.8 更新（2026-03-08）：
- 【重要修复】添加 ending_keywords 和 drama_keywords 定义，修复关键词检查失效问题
- 支持识别"未完待续"、"仅剩"等片尾特征关键词
"""
...
class ASRContentAnalyzer:
    ...
    # V14.8: 片尾旁白关键词（用于识别片尾特征）
    ending_keywords = [
        # 常见片尾用语
        "未完待续", "敬请期待", "精彩继续", "下集预告", "下集分解",
        "关注我", "点赞收藏", "一键三连", "关注点赞",
        # 时间暗示（总结性）
        "几天后", "几个月后", "一年后",
        # 总结性用语
    ...
    # V14.8: 正常剧情关键词（用于识别正常剧情）
    drama_keywords = [
        # 称谓
        "你", "我", "他", "她", "我们", "他们", "小姐", "先生", "老板", "老公", "老婆", "爸爸", "妈妈",
        # 动作
        "去", "来", "做", "吃", "喝", "看", "听", "说", "告诉", "问", "回答", "想", "要",
        # 情感
        "爱", "恨", "喜欢", "讨厌", "生气", "高兴", "难过", "担心", "害怕", "知道", "明白",
        # 剧情相关
        "秘密", "真相", "发现", "记得", "忘记",
        # 场景
        "这里", "那里", "家里", "公司", "学校", "医院",
        # 时间
        "今天", "明天", "昨天", "现在", "刚才", "马上", "立刻",
    ]
